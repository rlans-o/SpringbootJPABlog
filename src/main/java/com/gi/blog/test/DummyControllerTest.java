...
import com.gi.blog.model.RoleType;
import com.gi.blog.model.User;
import com.gi.blog.repository.UserRepository;
...
// 람다식 
//		User user = userRepository.findAllById(id).orElseThrow(()->{
